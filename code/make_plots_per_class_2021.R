...
ggsave(g1, filename = glue("figures/summary_eggs_hatched_updated_2021_final.png"), width = 11, height = 8, dpi=300)

ggsave(g2, filename = glue("figures/summary_egg_status_hatched_updated_2021_final.png"), width = 11, height = 8, dpi=300)

ggsave(g3, filename = glue("figures/summary_eggs_hatched_over_time_updated_2021_final.png"), width = 11, height = 7, dpi=300)
